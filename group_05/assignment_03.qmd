---
title: "assignment_3"
author: "Nhien Tran, Domenick Vitale, Clara Lu"
format: html
editor: visual
---
...
Members: Nhien Tran, Domenick Vitale, Clara Lu
...
These initial findings help identify key features, data completeness, and any potential anomalies, laying the foundation for deeper analysis.
...
plot_ly(salary_df, x = ~position, y = ~salary, type = 'bar', 
        text = ~paste("Position:", position, "<br>Salary:", salary),
        hoverinfo = 'text', 
        marker = list(color = 'lightblue')) %>%
  layout(title = "Salary by Position",
